...
function createFetchPatch(params, originalFetch, resolveProxyURL) {
    return function patchedFetch(input, init) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const modifiedInit = Object.assign(Object.assign({}, init), { dispatcher: new undici.ProxyAgent(Object.assign(Object.assign(Object.assign({ uri: proxyURL, allowH2, headers: proxyAuthorization ? { 'Proxy-Authorization': proxyAuthorization } : undefined }, (requestCA ? { requestTls: { ca: requestCA } } : {})), (proxyCA ? { proxyTls: { ca: proxyCA } } : {})), { clientFactory: (origin, opts) => new undici.Pool(origin, opts).compose((dispatch) => {
