...
const _systemCertificatesPromises = new Map();
function loadSystemCertificates(params) {
    var _a;
    const loadFromNode = !!((_a = params.loadSystemCertificatesFromNode) === null || _a === void 0 ? void 0 : _a.call(params)); // Checking if function exists for backward compatibility.
    let systemCertificatesPromise = _systemCertificatesPromises.get(loadFromNode);
    if (!systemCertificatesPromise) {
        if (loadFromNode) {
            systemCertificatesPromise = (() => __awaiter(this, void 0, void 0, function* () {
                const start = Date.now();
                const certs = yield readNodeSystemCertificates(params.log);
...
function readNodeSystemCertificates(log) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            return yield new Promise((resolve, reject) => {
                ...
                const worker = new worker_threads_1.Worker(path.join(__dirname, 'systemCertificatesWorker.js'), { name: 'System certificate loader' });
                worker.unref();
                let settled = false;
                worker.once('message', (certs) => {
                    settled = true;
